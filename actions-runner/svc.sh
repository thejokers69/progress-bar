...
SVC_NAME="actions.runner.thejokers69-progress-bar.TheJokers69MLs-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (thejokers69-progress-bar.TheJokers69MLs-MacBook-Pro)"
